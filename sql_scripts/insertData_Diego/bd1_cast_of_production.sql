...
--
-- Table structure for table `cast_of_production`
--

DROP TABLE IF EXISTS `cast_of_production`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cast_of_production` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_cast_member` int NOT NULL,
  `movie_character` varchar(240) NOT NULL,
  `production_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_id_cast_member_cop` (`id_cast_member`),
  KEY `FK_production_id_cop` (`production_id`),
...
--
-- Dumping data for table `cast_of_production`
--

LOCK TABLES `cast_of_production` WRITE;
/*!40000 ALTER TABLE `cast_of_production` DISABLE KEYS */;
/*!40000 ALTER TABLE `cast_of_production` ENABLE KEYS */;
UNLOCK TABLES;
