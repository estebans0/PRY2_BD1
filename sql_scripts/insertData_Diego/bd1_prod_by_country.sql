...
--
-- Table structure for table `prod_by_country`
--
...
CREATE TABLE `prod_by_country` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_ID_CUNTRY_PBC` (`id_production`),
  KEY `FK_ID_PRODUCTION_PBC` (`id_country`),
...
--
-- Dumping data for table `prod_by_country`
--

LOCK TABLES `prod_by_country` WRITE;
/*!40000 ALTER TABLE `prod_by_country` DISABLE KEYS */;
/*!40000 ALTER TABLE `prod_by_country` ENABLE KEYS */;
UNLOCK TABLES;
